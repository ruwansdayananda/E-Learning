//import components, libraries and files
...
export const StudyMaterials = () => {
  //define states for material classe
  const [subject, setsubject] = useState("");
  const [usersubjects, setUsersubjects] = useState();
  const [files, setFiles] = useState([]);
  const [showAlert, setShowAlert] = useState(false);

  //import style object from core
  ...
  //fetch data from database when rendering page
  ...
  //trigger on select subject by student
  ...
  //check user type is equal to teacher and rendering components that relevent to teacher
  ...
  //check user type equal to student and render relevwnt component
